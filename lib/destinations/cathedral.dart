...
class Cathedrals extends StatefulWidget {
  const Cathedrals({super.key});

  @override
  State<Cathedrals> createState() => _CathedralsState();
}

class _CathedralsState extends State<Cathedrals> {
        ...
        children: [
          ...
          Expanded(
            child: StreamBuilder<QuerySnapshot>(
              stream:
                  FirebaseFirestore.instance.collection('cathedral').snapshots(),
