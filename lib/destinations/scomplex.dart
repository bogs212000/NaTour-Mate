...
class Sportscomplex extends StatefulWidget {
  const Sportscomplex({super.key});

  @override
  State<Sportscomplex> createState() => _SportscomplexState();
}

class _SportscomplexState extends State<Sportscomplex> {
        ...
        children: [
          ...
          Expanded(
            child: StreamBuilder<QuerySnapshot>(
              stream:
                  FirebaseFirestore.instance.collection('scomplex').snapshots(),
