...
class Hotspring extends StatefulWidget {
  const Hotspring({super.key});

  @override
  State<Hotspring> createState() => _HotspringState();
}

class _HotspringState extends State<Hotspring> {
        ...
        children: [
          ...
          Expanded(
            child: StreamBuilder<QuerySnapshot>(
              stream:
                  FirebaseFirestore.instance.collection('hspring').snapshots(),
